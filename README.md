...
1. Add CMakeUnit using [FetchContent][cmake::FetchContent], add CMakeUnit source folder to
   [CMAKE_MODULE_PATH][cmake::CMAKE_MODULE_PATH] for your convenience and include CMakeUnit.
...
2. Add CMakeUnit as a git submodule, add path to CMakeUnit root folder to
   [CMAKE_MODULE_PATH][cmake::CMAKE_MODULE_PATH] for your convenience and include CMakeUnit.
...
3. Add a copy of [CMakeUnit.cmake](CMakeUnit.cmake) to the folder of your choice, add 
   this folder to [CMAKE_MODULE_PATH][cmake::CMAKE_MODULE_PATH] for your convenience and include CMakeUnit.
...
2. Add the location of CMakeUnit module and location of every module you want to
